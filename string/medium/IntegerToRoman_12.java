...
public class IntegerToRoman_12 {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(s.intToRoman2(94)); // XCIV
        System.out.println(s.intToRoman2(1994)); // MCMXCIV
        System.out.println(s.intToRoman2(3)); // III
        System.out.println(s.intToRoman2(4)); // IV
        System.out.println(s.intToRoman2(9)); // IX
        System.out.println(s.intToRoman2(58)); // LVIII
    }
