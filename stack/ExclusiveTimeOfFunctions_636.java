...
public class ExclusiveTimeOfFunctions_636 {
    ...
    public static void main(String[] args) {
        ...
        SolutionUtils.print(s.exclusiveTime(3, Arrays.asList("0:start:0", "1:start:2", "1:end:5", "2:start:6", "2:end:9", "0:end:12"))); // [5,4,4]
        SolutionUtils.print(s.exclusiveTime(3, Arrays.asList("0:start:0", "1:start:2", "2:start:4", "2:end:6", "1:end:7", "2:end:8"))); // [3,3,3]
