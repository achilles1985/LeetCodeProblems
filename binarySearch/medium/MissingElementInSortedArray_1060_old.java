...
public class MissingElementInSortedArray_1060_old {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(s.search2(new int[] {1,2,3,4,6})); //5
        System.out.println(s.search2(new int[] {2,3,4,5})); //1
        System.out.println(s.search2(new int[] {1,2,3,4,6,7,8})); //5
        System.out.println(s.search2(new int[] {1,2,3,4,5,6,8,9})); //7
        System.out.println(s.search2(new int[] {1,2,4,5})); //3
    }
